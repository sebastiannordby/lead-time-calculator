...
namespace LeadTimeCalculator.Production.Domain.Tests.Unit.Calendar
{
    /// <summary>
    ...
    public class ExerciseDefinedTests
    {
            ...
            string inputDateStr, double workingHoursToAdd, string expectedDateStr)
        {
            ...
            var work = workingHoursToAdd > 0
                ? workdayCalendar.AddWorkingDays(inputDate, workingHoursToAdd)
                : workdayCalendar.SubtractWorkingDays(inputDate, -workingHoursToAdd);
